## ddkcore.py - useful module of DDKARMY
##
import os, sys, time
...
DDKARMY_banner = """
 _____  _____  _  __            _____  __  ____     __
 |  __ \|  __ \| |/ /      /\   |  __ \|  \/  \ \   / /
 | |  | | |  | | ' /      /  \  | |__) | \  / |\ \_/ / 
 | |  | | |  | |  <      / /\ \ |  _  /| |\/| | \   /  
 | |__| | |__| | . \    / ____ \| | \ \| |  | |  | |   
...
v1.0, Author: GoriMental
 ×=========================================×
 ×         Developer - Gori Mental         ×
 ×      Instagram - @deepdarknowledge      ×
 ×         Telegram - @DdkCreator          ×
 ×=========================================×
